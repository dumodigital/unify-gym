...
const TRAINERS: Trainer[] = [
  ...
  },
  {
    ...
    bio: 'Dennis is a trainer and athlete with over six years of professional experience in the fitness industry. He holds a bachelor\'s degree in Kinesiology and has worked with clients ranging from youth athletes to older adults, adapting training through a variety of fitness modalities to meet each person where they are. His approach combines recovery, strength, endurance, and nutrition to support overall health and performance. Dennis\'s goal is to build sustainable habits that empower clients with the tools and confidence to succeed both in the gym and in everyday life.',
